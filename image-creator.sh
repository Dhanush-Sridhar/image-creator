...
RUNTIME_IMAGE_PACKAGES="less htop wget vim ssh linux-image-generic nodm xinit openbox xterm network-manager x11-xserver-utils libmbedtls12 apt-offline nano psmisc dosfstools lsscsi x11vnc vsftpd libxcb-* libxkbcommon-x11-0 net-tools lsof"
...
=======
            umount_dev_sys_proc "${ROOTFS_PATH}" || echo "No rootfs left mounted, good."
>>>>>>> 9bc70ec36406c568a8d828da832c35a49b822e12
            rm -rf "${ROOTFS_PATH}"
            shift
            ;;
        --install-qt)
